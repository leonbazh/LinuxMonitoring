...
Джон зашел в кабинет Себа, сел за его компьютер и сразу открыл подозрительно короткий файл с заметками.
...
Написать bash-скрипт или программу на С, генерирующий 5 файлов логов **nginx** в *combined* формате.
...
💡 [Нажми сюда](https://forms.yandex.ru/cloud/641818e069387223cba1286e/), **чтобы поделиться с нами обратной связью на этот проект**. Это анонимно и поможет команде Продукта сделать твоё обучение лучше.
